...
void FreqCounter::start(int ms) {
    ...
    //TIMSK0 &=~(1<<TOIE0);       // disable Timer0  //disable  millis and delay  // wir brauchen Timer0, daher auskommentiert
...
if (FreqCounter::f_tics >= FreqCounter::f_period) {         	
    ...
    //TIMSK0 |=(1<<TOIE0);     			// enable Timer0 again // millis and delay  // wir brauchen Timer0, daher auskommentiert
